...
header("Content-Security-Policy: frame-ancestors 'self' https://natdem.org; script-src 'strict-dynamic' 'nonce-$nonce'  https:; object-src 'self'; base-uri 'none'; require-trusted-types-for 'script';  report-uri https://csp.natdem.org;");
