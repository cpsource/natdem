...
# Subroutine 4: Match the phrase 'Connection closed by invalid user' and capture user
...
# Subroutine 7: Match the text inside square brackets (e.g., [preauth])
...
log_message = "Sep 11 11:59:56 ip-172-26-10-222 sshd[137445]: Connection closed by invalid user guest 121.202.195.103 port 17284 [preauth]"
