...
<script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha384-KyZXEAg3QhqLMpG8r+Knujsl5/6Q4re+5vh+6XUR6kG6DzE1Ilf9mbrZfl68YV5/" crossorigin="anonymous" nonce="$nonce"></script>
</head>
<body>
...
<?php include 'footer.php'; ?>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/5.3.1/js/bootstrap.bundle.min.js nonce="<?php echo $nonce; ?>"> </script>
